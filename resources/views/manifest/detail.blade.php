...
<div class="row no-print">
  <div class="col-xs-12">
    <a href="{!! action('ManifestController@print',$detailatas->id) !!}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i> Print</a>
  </div>
</div>
