...
class ManifestController extends Controller
{
    ...
    public function index()
    {
        ...
        $detail = DB::select(DB::raw("SELECT m.id as id, m.tanggal as tglmanifest, m.no_manifest as nomanifest, k.nama as sopir, n.tglbrgkt as tglbrgkt, n.tgltiba as tgltiba FROM notakirims as n inner join manifests as m on m.id=n.manifest_id inner join karyawans as k on k.id=m.karyawan_id_sopir group by m.id, m.tanggal, k.nama,m.no_manifest, n.tglbrgkt, n.tgltiba"));
    ...
    public function detail($id)
    {
        ...
        $detailatas = DB::select(DB::raw("SELECT m.id, m.no_manifest as nomanifest, m.tanggal as tanggal, k.nama as pembuat, kn.nama as sopir, n.tglbrgkt as tglbrgkt, n.tgltiba as tgltiba FROM notakirims as n inner join manifests as m on n.manifest_id=m.id inner join karyawans as k on n.karyawan_id=k.id inner join karyawans as kn on m.karyawan_id_sopir=kn.id where m.id='$id' limit 1"));
