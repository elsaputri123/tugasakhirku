...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo e(url('manifest/create')); ?>" class="active"><i class="fa fa-dashboard"></i> Input Data Manifest</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(url('manifest')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                          ...
                          <table class="table">
                            <tr>
                              <div class="form-group">
                                ...
                                <input style="width: 30%;" type="text" name="nomanifest" value="<?php echo e($nomanifest); ?>" class="form-control" readonly="" required>
