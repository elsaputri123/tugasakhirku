...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo e(url('tarif/create')); ?>" class="active"><i class="fa fa-dashboard"></i> Tambah Data Tarif</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Tambah Tarif</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form role="form" action="<?php echo e(url('tarif')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
