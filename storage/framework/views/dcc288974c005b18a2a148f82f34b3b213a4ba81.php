...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo e(url('kendaraan/create')); ?>" class="active"><i class="fa fa-dashboard"></i> Tambah Data Kendaraan</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(url('kendaraan')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
