      ...
      <table id="example1" class="table table-bordered table-striped" style="overflow-x:auto;">
       ...
       <?php $__currentLoopData = $karyawans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <td>
            <a class="btn btn-success" href="<?php echo action('KaryawanController@edit',$k->id); ?>">Ubah</a>
          </td>
          <td>
            <form action ="<?php echo e(route('karyawan.destroy',$k->id)); ?>" method="post"><?php echo e(method_field("DELETE")); ?> <?php echo e(csrf_field()); ?> <input type="submit" value="hapus" name="submit" class="btn btn-success"> </form>
          </td>  
        </tr>
