          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('kendaraan.update', $kendaraans->id)); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                  ...
                  <input type="text" name="nama" class="form-control" value="<?php echo e($kendaraans->nama); ?>"/>
                </div>
                 <div class="form-group">
                  <label>No. Polisi</label>
                  <input type="text" name="nopolisi" class="form-control" value="<?php echo e($kendaraans->no_polisi); ?>"/>
                </div>
                 <div class="form-group">
                  <label>Kapasitas</label>
                  <input type="number" name="kapasitas" class="form-control" value="<?php echo e($kendaraans->kapasitas); ?>"/>
                </div>
              <!-- /.box-body -->
