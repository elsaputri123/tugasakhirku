          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('pelanggan.update', $pelanggans->id)); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                  ...
                  <input type="text" name="nama" class="form-control" value="<?php echo e($pelanggans->nama); ?>"/>
                </div>
                 <div class="form-group">
                  <label>Alamat</label>
                  <input type="text" name="alamat" class="form-control" value="<?php echo e($pelanggans->alamat); ?>"/>
                </div>
                 <div class="form-group">
                  <label>No. Tlp</label>
                  <input type="number" name="notlp" class="form-control" value="<?php echo e($pelanggans->no_tlp); ?>"/>
                </div>
              <!-- /.box-body -->
