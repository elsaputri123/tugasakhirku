...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo e(url('barang.edit')); ?>" class="active"><i class="fa fa-dashboard"></i> Edit Data Barang</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('barang.update', $barangs->id)); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <select name="jenis" class="form-control" required="">
                    <option selected="" value="<?php echo e($barangs->jenis_id); ?>"><?php echo e($barangs->jenis->nama); ?></option>
                  ...
                  <input type="text" name="nama" class="form-control" value="<?php echo e($barangs->nama); ?>"/>
                </div>
                <div class="form-group">
                  <label>Satuan</label>
                  <input type="text" name="satuan" class="form-control" value="<?php echo e($barangs->satuan); ?>"/>
                </div>
              <!-- /.box-body -->
