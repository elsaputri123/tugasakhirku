      ...
      <table id="example1" class="table table-bordered table-striped">
       ...
       <?php $__currentLoopData = $jenis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <td>
            <a class="btn btn-success" href="<?php echo action('JenisController@edit',$j->id); ?>">Ubah</a>
          </td>
          <td>
            <form action ="<?php echo e(route('jenis.destroy',$j->id)); ?>" method="post"><?php echo e(method_field("DELETE")); ?> <?php echo e(csrf_field()); ?> <input type="submit" value="hapus" name="submit" class="btn btn-success"> </form>
          </td>  
        </tr>
