          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('karyawan.update', $karyawans->id)); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                  ...
                  <label>Foto</label>
                  <input style="width: 30%;" type="file" name="foto" class="form-control" value="<?php echo e($karyawans->foto); ?>"/>
                </div>

                 <div class="form-group">
                  <label>Nama Karyawan</label>
                  <input style="width: 30%;" type="text" name="nama" class="form-control" value="<?php echo e($karyawans->nama); ?>"/>
                </div>
                ...
                <div class="form-group">
                  <label>Alamat</label>
                  <input style="width: 30%;" type="text" name="alamat" class="form-control" value="<?php echo e($karyawans->alamat); ?>"/>
                </div>

                <div class="form-group">
                  <label>No. Telp</label>
                  <input style="width: 30%;" type="text" name="notlp" class="form-control" value="<?php echo e($karyawans->no_tlp); ?>"/>
                </div>

                 <div class="form-group">
                  <label>Tempat Lahir</label>
                  <input style="width: 30%;" type="text" name="tmptlahir" class="form-control" value="<?php echo e($karyawans->tmpt_lahir); ?>"/>
                </div>

                <div class="form-group">
                  <label>Tanggal Lahir</label>
                  <input style="width: 30%;" type="date" name="tgllahir" class="form-control" value="<?php echo e($karyawans->tgl_lahir); ?>"/>
                </div>

                <div class="form-group"> 
                  <label>Username</label> 
                  <input style="width: 30%;" type="text" name="username" class="form-control" value="<?php echo e($karyawans->users->username); ?>"/> 
                </div>

                <div class="form-group">
                  <label>Email</label>
                  <input style="width: 30%;" type="text" name="email" class="form-control" value="<?php echo e($karyawans->users->email); ?>"/>
                </div>
              </div>
              <!-- /.box-body -->
